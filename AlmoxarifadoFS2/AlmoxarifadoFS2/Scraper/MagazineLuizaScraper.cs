...
public class MagazineLuizaScraper
{
    public string ObterPreco(string descricaoProduto, int idProduto)
    {
        try
        {
            ...
            using (IWebDriver driver = new ChromeDriver())
            {
                ...
                if (priceElement != null)
                {
                    ...
                    RegistrarLog("132630", "Igor", DateTime.Now, "WebScraping - Magazine Luiza", "Sucesso", idProduto);
                ...
                else
                {
                    ...
                    // Registra o log com o ID do produto
                    RegistrarLog("132630", "Igor", DateTime.Now, "WebScraping - Magazine Luiza", "Preço não encontrado", idProduto);
        ...
        catch (Exception ex)
        {
            ...
            // Registra o log com o ID do produto
            RegistrarLog("132630", "Igor", DateTime.Now, "Web Scraping - Magazine Luiza", $"Erro: {ex.Message}", idProduto);
